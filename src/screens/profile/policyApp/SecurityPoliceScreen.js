...
class SecurityPolicyScreen extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      policy: {}
  ...
  async componentDidMount() {
    LoadingModal.show();
    let res = await Fetch.get(Const.API.PROFILE.GET_POLICY_APP, { filter: 'chinh-sach-bao-mat' });
    LoadingModal.hide();
    ...
    return (
      <Container>
        <Header
          ...
          text={Lang.profile.text_information_security_policy}
