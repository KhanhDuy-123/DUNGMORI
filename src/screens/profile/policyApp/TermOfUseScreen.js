...
class TermOfUseScreen extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      policy: {}
  ...
  async componentDidMount() {
    LoadingModal.show();
    let res = await Fetch.get(Const.API.PROFILE.GET_POLICY_APP, { filter: 'dieu-khoan-su-dung' });
    LoadingModal.hide();
    ...
    return (
      <Container>
        <Header
          ...
          text={Lang.profile.text_terms_of_use}
        ...
        <ScrollView>
          <View style={styles.container}>
            ...
            {policy.content && <HTML html={policy.content} onLinkPress={this.onLinkPress} />}
          </View>
        </ScrollView>
      </Container>
    );
